...
1.  「**非アクティブ化 - 課金管理者**」 ブレードで、再度 「**非アクティブ化**」 をクリックします。
...
1. **時間**、**要求元**、**操作**、**リソース名**、**スコープ**、**件名**などの詳細情報を取得できることに注意してください。 
...
1. 「**Azure Active Directory**」の「**管理**」セクションにある、「**ライセンス**」をクリックし、「**すべての製品**」をクリックします。

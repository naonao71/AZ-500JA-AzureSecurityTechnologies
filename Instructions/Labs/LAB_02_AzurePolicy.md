...
- 特定のリージョンでのみリソースの作成を許可する、許可されている場所ポリシーを作成する
- 許可されている場所でのみリソースが作成されることをテストする
...
#### タスク 2: 許可されている場所ポリシーの割り当てをテストする
...
1. 「**仮想ネットワークの作成**」 ブレードの 「**確認および作成**」 タブで [**作成**] をクリックし、「**検証が失敗しました**」メッセージを確認します。 

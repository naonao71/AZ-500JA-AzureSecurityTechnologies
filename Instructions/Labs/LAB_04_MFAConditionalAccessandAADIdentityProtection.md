...
1. Azure portal で Azure portal ページの上部にある「**リソース、サービス、ドキュメントの検索**」テキスト ボックスで、「**カスタム テンプレートをデプロイする**」と入力します。
...
2. 「**ロボットではないことを証明するのを手伝ってください**」ブレードにキャプチャ コードを追加し、「**送信**」ボタンをクリックします。 
